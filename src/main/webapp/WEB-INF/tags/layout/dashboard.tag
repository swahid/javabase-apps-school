      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href='<c:url value="/class"/>'><i class="fa fa-link"></i> <span>Class</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href='<c:url value="/class/manage"/>'>Manage Class</a></li>
                <li><a href='<c:url value="/class/section"/>'>Manage Section</a></li>
                <li><a href='<c:url value="/class/syllabus"/>'>Manage Syllabus</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href='<c:url value="/acaSession"/>'>Academic Session</a></li>
