          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div id="gallerySLide" class="gallery_area">
                <a href="img/gallery/img-large1.jpg" title="This is Title">
                  <img class="gallery_img" src="<c:url value='/resources/images/homepage/gallery/img-small1.jpg'/>" alt="img" />
                <span class="view_btn">View</span>
                </a>
                <a href="img/gallery/img-large2.jpg" title="This is Title2">
                  <img class="gallery_img" src="<c:url value='/resources/images/homepage/gallery/img-small2.jpg'/>" alt="img" />
                  <span class="view_btn">View</span>
                </a>
                <a href="img/gallery/img-large3.jpg" title="This is Title3">
                  <img class="gallery_img" src="<c:url value='/resources/images/homepage/gallery/img-small3.jpg'/>" alt="img" />
                  <span class="view_btn">View</span>
                </a>
                <a href="img/gallery/img-large4.jpg" title="This is Title4">
                  <img class="gallery_img" src="<c:url value='/resources/images/homepage/gallery/img-small4.jpg'/>" alt="img" />
                  <span class="view_btn">View</span>
                </a>
